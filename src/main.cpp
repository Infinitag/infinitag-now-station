...
void setup() {
    ...
    neopixelBootTest();
    // Danach laeuft im loop() ein R/G/B-Cycle ueber alle LEDs (siehe unten).
    // Start mit Rot, damit kein kurzer Weiss-Blitz beim Boot auftritt.
    neopixelSetSolid(strip.Color(255, 0, 0));
